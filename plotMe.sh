...
python src/load-plot.py --model='freqSum_NoTiedWeight_Medium' --model_name='2017-07-11-061415' --data_base_dir='/home/chuong/EEG-Project/processed_data' --output_base_dir='/home/chuong/EEG-Project/output_features'
