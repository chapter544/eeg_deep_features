...
def build_model(model, x, x_dim, 
	...
	if model == 'big':
		...
		loss, decoded, l1_loss = build_fc_freq_4_30_NoTiedWeight_BN_Tiny(
			   x, x_dim, dropout_keep_prob, is_training,
			   gamma=gamma, activation=feature_activation)
	elif model == 'freq_4_30_TiedWeight_Small':
		...
		loss, decoded, l1_loss = build_fc_freq_5_NoTiedWeight_BN_Contrib_Tiny(
			   x, x_dim,  dropout_keep_prob, is_training,
			   gamma=gamma, activation=feature_activation)
	elif model == 'freq_5_NoTiedWeight_BN_Contrib_Behind_Tiny':
		loss, decoded, l1_loss = build_fc_freq_5_NoTiedWeight_BN_Contrib_Behind_Tiny(
			   x, x_dim,  dropout_keep_prob, is_training,
			   gamma=gamma, activation=feature_activation)
	elif model == 'freq_5_NoTiedWeight_BN_Wrapper_Tiny':
		...
		loss, decoded, l1_loss = build_fc_freq_5_NoTiedWeight_BN_Wrapper_Behind_Tiny(
			   x, x_dim,  dropout_keep_prob, is_training,
			   gamma=gamma, activation=feature_activation)
	elif model == 'freq_4_30_NoTiedWeight_BN_Wrapper_Behind_Tiny':
		loss, decoded, l1_loss = build_fc_freq_4_30_NoTiedWeight_BN_Wrapper_Behind_Tiny(
			   x, x_dim,  dropout_keep_prob, is_training,
			   gamma=gamma, activation=feature_activation)
	elif model == 'freq_5_NoTiedWeight_L1_Tiny':
