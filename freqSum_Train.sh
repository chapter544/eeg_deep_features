...
python src/auto-encoder.py --data_base_dir='/home/chuong/EEG-Project/processed_data' --trained_models_base_dir='/home/chuong/EEG-Project/trained_models' --model='freqSum_NoTiedWeight_Small' --data_type='freqSum' --batch_size=128 --num_epochs=200 --learning_rate=1e-4 --num_epochs_save=100 --gamma=1e-7 --data_normalization='normalize' --feature_activation='elu'
