...
python src/auto-encoder.py --data_base_dir='/home/chuong/EEG-Project/processed_data' --trained_models_base_dir='/home/chuong/EEG-Project/trained_models' --model='freqSum_NoTiedWeight_BN_Wrapper_Behind_Tiny' --data_type='freqSum' --batch_size=500 --num_epochs=400 --learning_rate=1e-3 --num_epochs_save=400 --gamma=1e-5 --data_normalization='normalize' --feature_activation='elu'
